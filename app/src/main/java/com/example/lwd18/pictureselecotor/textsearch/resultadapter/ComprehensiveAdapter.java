    ...
    if (holder instanceof NormalViewHolder) {
     ...
     //单品
      if (ware.getType() == 2) {
        ...
        wareHolder.linearLayoutout.setVisibility(View.GONE);
        //1 返利`  2 优惠券
        ...
        wareHolder.linearLayoutout.setVisibility(View.VISIBLE);
        ((NormalViewHolder) holder).titleProduct.setText(list.get(index).getTitle());
        Glide.with(holder.itemView.getContext())
            .load(list.get(index).getPicUrl())
        ...
        wareHolder.linearLayoutout.setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
            ...
            intent.putExtra("price", list.get(index).getPrice());
