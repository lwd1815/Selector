...
public class GoodSAttrRvNAdapter8 extends RecyclerView.Adapter<GoodSAttrRvNAdapter8.MyAdapter> {
  private Context context;
  private List<String> mlist;
  private List<String> selectedlist;
  public GoodSAttrRvNAdapter8(Context context) {
  ...
  @Override
  public GoodSAttrRvNAdapter8.MyAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
  ...
  @Override public void onBindViewHolder(final GoodSAttrRvNAdapter8.MyAdapter holder, final int position) {
  ...
  public void setToggleOn(boolean isToggle,GoodSAttrRvNAdapter8.MyAdapter holder,  int position){
    mIsToggle=isToggle;
    if (isToggle){
      holder.attr.setBackgroundResource(R.drawable.goods_attr_selected_shape);
      holder.attr.setTextColor(Color.WHITE);
  ...
  public void toggle(GoodSAttrRvNAdapter8.MyAdapter holder,  int position) {
