...
public class GoodSAttrRvNAdapter5 extends RecyclerView.Adapter<GoodSAttrRvNAdapter5.MyAdapter> {
  private Context context;
  private List<String> mlist;
  private List<String> selectedlist;
  public GoodSAttrRvNAdapter5(Context context) {
  ...
  @Override
  public GoodSAttrRvNAdapter5.MyAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
  ...
  @Override public void onBindViewHolder(final GoodSAttrRvNAdapter5.MyAdapter holder, final int position) {
  ...
  public void setToggleOn(boolean isToggle,GoodSAttrRvNAdapter5.MyAdapter holder,  int position){
    mIsToggle=isToggle;
    if (isToggle){
      holder.attr.setBackgroundResource(R.drawable.goods_attr_selected_shape);
      holder.attr.setTextColor(Color.WHITE);
  ...
  public void toggle(GoodSAttrRvNAdapter5.MyAdapter holder,  int position) {
