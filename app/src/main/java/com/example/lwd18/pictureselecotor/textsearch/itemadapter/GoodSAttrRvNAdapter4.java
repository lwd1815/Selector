...
public class GoodSAttrRvNAdapter4 extends RecyclerView.Adapter<GoodSAttrRvNAdapter4.MyAdapter> {
  private Context context;
  private List<String> mlist;
  private List<String> selectedlist;
  public GoodSAttrRvNAdapter4(Context context) {
  ...
  @Override
  public GoodSAttrRvNAdapter4.MyAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
  ...
  @Override public void onBindViewHolder(final GoodSAttrRvNAdapter4.MyAdapter holder, final int position) {
  ...
  public void setToggleOn(boolean isToggle,GoodSAttrRvNAdapter4.MyAdapter holder,  int position){
    mIsToggle=isToggle;
    if (isToggle){
      holder.attr.setBackgroundResource(R.drawable.goods_attr_selected_shape);
      holder.attr.setTextColor(Color.WHITE);
  ...
  public void toggle(GoodSAttrRvNAdapter4.MyAdapter holder,  int position) {
