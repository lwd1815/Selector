...
public class GoodSAttrRvNAdapter3 extends RecyclerView.Adapter<GoodSAttrRvNAdapter3.MyAdapter> {
  private Context context;
  private List<String> mlist;
  private List<String> selectedlist;
  public GoodSAttrRvNAdapter3(Context context) {
  ...
  @Override
  public GoodSAttrRvNAdapter3.MyAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
  ...
  @Override public void onBindViewHolder(final GoodSAttrRvNAdapter3.MyAdapter holder, final int position) {
  ...
  public void setToggleOn(boolean isToggle,GoodSAttrRvNAdapter3.MyAdapter holder,  int position){
    mIsToggle=isToggle;
    if (isToggle){
      holder.attr.setBackgroundResource(R.drawable.goods_attr_selected_shape);
      holder.attr.setTextColor(Color.WHITE);
  ...
  public void toggle(GoodSAttrRvNAdapter3.MyAdapter holder,  int position) {
