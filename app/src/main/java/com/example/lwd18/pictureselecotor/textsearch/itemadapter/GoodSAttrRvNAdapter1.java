...
public class GoodSAttrRvNAdapter1 extends RecyclerView.Adapter<GoodSAttrRvNAdapter1.MyAdapter> {
  private Context context;
  private List<String> mlist;
  private int mposition;
  private List<String> selectedlist;
  public GoodSAttrRvNAdapter1(Context context) {
  ...
  @Override
  public GoodSAttrRvNAdapter1.MyAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
    //如果使用textview,点击闪烁,使用checkBox则正常
  ...
  @Override public void onBindViewHolder(final GoodSAttrRvNAdapter1.MyAdapter holder, final int position) {
  ...
  public void setToggleOn(boolean isToggle,GoodSAttrRvNAdapter1.MyAdapter holder,  int position){
    mIsToggle=isToggle;
    if (isToggle){
      holder.attr.setBackgroundResource(R.drawable.goods_attr_selected_shape);
      holder.attr.setTextColor(Color.WHITE);
  ...
  public void toggle(GoodSAttrRvNAdapter1.MyAdapter holder,  int position) {
