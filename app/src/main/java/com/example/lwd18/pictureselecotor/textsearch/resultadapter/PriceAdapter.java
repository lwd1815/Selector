...
public class PriceAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    if (holder instanceof NormalViewHolder) {
     ...
     NormalViewHolder wareHolder = (NormalViewHolder) holder;
      ...
      if (ware.getType() == 2) {
        ...
        wareHolder.linearLayout.setVisibility(View.GONE);
        ...
        wareHolder.linearLayout.setVisibility(View.VISIBLE);
        ((NormalViewHolder) holder).titleProduct.setText(list.get(index).getTitle());
        Glide.with(holder.itemView.getContext())
            .load(list.get(index).getPicUrl())
        ...
        wareHolder.linearLayout.setOnClickListener(new View.OnClickListener() {
          @Override public void onClick(View v) {
  ...
  public class NormalViewHolder extends RecyclerView.ViewHolder {
    ...
    public NormalViewHolder(View itemView) {
      ...
      linearLayout = (LinearLayout) itemView.findViewById(R.id.com_out_ll);
