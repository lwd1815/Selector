...
public class GoodSAttrRvNAdapter10 extends RecyclerView.Adapter<GoodSAttrRvNAdapter10.MyAdapter> {
  private Context context;
  private List<String> mlist;
  private List<String> selectedlist;
  public GoodSAttrRvNAdapter10(Context context) {
  ...
  @Override
  public GoodSAttrRvNAdapter10.MyAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
  ...
  public void setToggleOn(boolean isToggle,GoodSAttrRvNAdapter10.MyAdapter holder,  int position){
    mIsToggle=isToggle;
    if (isToggle){
      holder.attr.setBackgroundResource(R.drawable.goods_attr_selected_shape);
      holder.attr.setTextColor(Color.WHITE);
  ...
  public void toggle(GoodSAttrRvNAdapter10.MyAdapter holder,  int position) {
