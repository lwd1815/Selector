...
public class GoodSAttrRvNAdapter2 extends RecyclerView.Adapter<GoodSAttrRvNAdapter2.MyAdapter> {
  private Context context;
  private List<String> mlist;
  private List<String> selectedlist;
  public GoodSAttrRvNAdapter2(Context context) {
  ...
  @Override
  public GoodSAttrRvNAdapter2.MyAdapter onCreateViewHolder(ViewGroup parent, int viewType) {
  ...
  @Override public void onBindViewHolder(final GoodSAttrRvNAdapter2.MyAdapter holder, final int position) {
  ...
  public void setToggleOn(boolean isToggle,GoodSAttrRvNAdapter2.MyAdapter holder,  int position){
    mIsToggle=isToggle;
    if (isToggle){
      holder.attr.setBackgroundResource(R.drawable.goods_attr_selected_shape);
      holder.attr.setTextColor(Color.WHITE);
  ...
  public void toggle(GoodSAttrRvNAdapter2.MyAdapter holder,  int position) {
